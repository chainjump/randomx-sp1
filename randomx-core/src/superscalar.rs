...
pub struct ScProgram<'a> {
    ...
    #[cfg(any(not(feature = "compact-superscalar"), test))]
    pub asic_latencies: [usize; 8],
    #[cfg(any(not(feature = "compact-superscalar"), test))]
    pub cpu_latencies: [usize; 8],
    address_reg: u8,
    #[cfg(any(not(feature = "compact-superscalar"), test))]
    pub ipc: f64,
    #[cfg(any(not(feature = "compact-superscalar"), test))]
...
impl ScProgram<'_> {
    pub fn generate(generator: &mut Blake2Generator) -> ScProgram<'static> {
        ...
        {
            decode_buffer =
                decode_buffer.fetch_next(&current_instr, decode_cycle, mul_count, generator);
        ...
        #[cfg(any(not(feature = "compact-superscalar"), test))]
        let mut cpu_latencies = [0; 8];
        for (i, &asic_latency) in asic_latencies.iter().enumerate() {
            if asic_latency > asic_latency_max {
                asic_latency_max = asic_latency;
                address_reg = i;
            }
            #[cfg(any(not(feature = "compact-superscalar"), test))]
            {
        ...
        for pair in exec.chunks_exact_mut(2) {
            ...
            pair[0].pair_handler_offset = (pair_index * std::mem::size_of::<PairHandler>()) as u16;
        }
    ...
    #[cfg(any(not(feature = "compact-superscalar"), test))]
    fn execute_reference(&self, ds: &mut [u64; 8]) {
        for instr in &self.prog {
    ...
    fn execute_compact(&self, ds: &mut [u64; 8]) {
        for instr in &self.exec {
            ...
            match instr.opcode {
                ...
                ScExecOpcode::IaddRs => ds[dst] = ds[dst].wrapping_add(ds[src] << instr.immediate),
                ...
                ScExecOpcode::ImulRcp => ds[dst] = ds[dst].wrapping_mul(instr.immediate),
            }
        }
    }
...
static PAIR_HANDLERS: [PairHandler; 100] = [
    execute_compact_pair_known::<0, 0>,
    execute_compact_pair_known::<0, 1>,
    execute_compact_pair_known::<0, 2>,
    execute_compact_pair_known::<0, 3>,
    execute_compact_pair_known::<0, 4>,
    execute_compact_pair_known::<0, 5>,
    execute_compact_pair_known::<0, 6>,
    execute_compact_pair_known::<0, 7>,
    execute_compact_pair_known::<0, 8>,
    execute_compact_pair_known::<0, 9>,
    execute_compact_pair_known::<1, 0>,
    execute_compact_pair_known::<1, 1>,
    execute_compact_pair_known::<1, 2>,
    execute_compact_pair_known::<1, 3>,
    execute_compact_pair_known::<1, 4>,
    execute_compact_pair_known::<1, 5>,
    execute_compact_pair_known::<1, 6>,
    execute_compact_pair_known::<1, 7>,
    execute_compact_pair_known::<1, 8>,
    execute_compact_pair_known::<1, 9>,
    execute_compact_pair_known::<2, 0>,
    execute_compact_pair_known::<2, 1>,
    execute_compact_pair_known::<2, 2>,
    execute_compact_pair_known::<2, 3>,
    execute_compact_pair_known::<2, 4>,
    execute_compact_pair_known::<2, 5>,
    execute_compact_pair_known::<2, 6>,
    execute_compact_pair_known::<2, 7>,
    execute_compact_pair_known::<2, 8>,
    execute_compact_pair_known::<2, 9>,
    execute_compact_pair_known::<3, 0>,
    execute_compact_pair_known::<3, 1>,
    execute_compact_pair_known::<3, 2>,
    execute_compact_pair_known::<3, 3>,
    execute_compact_pair_known::<3, 4>,
    execute_compact_pair_known::<3, 5>,
    execute_compact_pair_known::<3, 6>,
    execute_compact_pair_known::<3, 7>,
    execute_compact_pair_known::<3, 8>,
    execute_compact_pair_known::<3, 9>,
    execute_compact_pair_known::<4, 0>,
    execute_compact_pair_known::<4, 1>,
    execute_compact_pair_known::<4, 2>,
    execute_compact_pair_known::<4, 3>,
    execute_compact_pair_known::<4, 4>,
    execute_compact_pair_known::<4, 5>,
    execute_compact_pair_known::<4, 6>,
    execute_compact_pair_known::<4, 7>,
    execute_compact_pair_known::<4, 8>,
    execute_compact_pair_known::<4, 9>,
    execute_compact_pair_known::<5, 0>,
    execute_compact_pair_known::<5, 1>,
    execute_compact_pair_known::<5, 2>,
    execute_compact_pair_known::<5, 3>,
    execute_compact_pair_known::<5, 4>,
    execute_compact_pair_known::<5, 5>,
    execute_compact_pair_known::<5, 6>,
    execute_compact_pair_known::<5, 7>,
    execute_compact_pair_known::<5, 8>,
    execute_compact_pair_known::<5, 9>,
    execute_compact_pair_known::<6, 0>,
    execute_compact_pair_known::<6, 1>,
    execute_compact_pair_known::<6, 2>,
    execute_compact_pair_known::<6, 3>,
    execute_compact_pair_known::<6, 4>,
    execute_compact_pair_known::<6, 5>,
    execute_compact_pair_known::<6, 6>,
    execute_compact_pair_known::<6, 7>,
    execute_compact_pair_known::<6, 8>,
    execute_compact_pair_known::<6, 9>,
    execute_compact_pair_known::<7, 0>,
    execute_compact_pair_known::<7, 1>,
    execute_compact_pair_known::<7, 2>,
    execute_compact_pair_known::<7, 3>,
    execute_compact_pair_known::<7, 4>,
    execute_compact_pair_known::<7, 5>,
    execute_compact_pair_known::<7, 6>,
    execute_compact_pair_known::<7, 7>,
    execute_compact_pair_known::<7, 8>,
    execute_compact_pair_known::<7, 9>,
    execute_compact_pair_known::<8, 0>,
    execute_compact_pair_known::<8, 1>,
    execute_compact_pair_known::<8, 2>,
    execute_compact_pair_known::<8, 3>,
    execute_compact_pair_known::<8, 4>,
    execute_compact_pair_known::<8, 5>,
    execute_compact_pair_known::<8, 6>,
    execute_compact_pair_known::<8, 7>,
    execute_compact_pair_known::<8, 8>,
    execute_compact_pair_known::<8, 9>,
    execute_compact_pair_known::<9, 0>,
    execute_compact_pair_known::<9, 1>,
    execute_compact_pair_known::<9, 2>,
    execute_compact_pair_known::<9, 3>,
    execute_compact_pair_known::<9, 4>,
    execute_compact_pair_known::<9, 5>,
    execute_compact_pair_known::<9, 6>,
    execute_compact_pair_known::<9, 7>,
    execute_compact_pair_known::<9, 8>,
    execute_compact_pair_known::<9, 9>,
];

#[cfg(feature = "unchecked-superscalar")]
#[inline(always)]
fn execute_compact_pair_unchecked(ds: &mut [u64; 8], first: &ScExecInstr, second: &ScExecInstr) {
    debug_assert_eq!(
        first.pair_handler_offset as usize % std::mem::size_of::<PairHandler>(),
        0
    );
    debug_assert!(
...
fn execute_compact_instruction_unchecked(ds: &mut [u64; 8], instr: &ScExecInstr) {
    ...
    let result = match instr.opcode {
        ScExecOpcode::IsubR => dst_value.wrapping_sub(exec_read_register(ds, instr.src_offset)),
        ...
        ScExecOpcode::ImulR => dst_value.wrapping_mul(exec_read_register(ds, instr.src_offset)),
...
fn exec_read_register(registers: &[u64; 8], byte_offset: u8) -> u64 {
    ...
    debug_assert!(
        byte_offset as usize <= std::mem::size_of_val(registers) - std::mem::size_of::<u64>()
    );
    unsafe {
        *registers
            .as_ptr()
...
mod reciprocal_tests {
    ...
    fn superscalar_reciprocal_is_computed_during_generation() {
        ...
        for _ in 0..64 {
            ...
            assert_eq!(instr.reciprocal, randomx_reciprocal(instr.imm32 as u64));
...
mod compact_tests {
    ...
    #[test]
    fn compact_execution_matches_reference_execution() {
        ...
        for seed_index in 0..128_u64 {
            ...
            for program_index in 0..8_u64 {
                ...
                for input_index in 0..64_u64 {
                    let mut reference = [0_u64; 8];
                    for (register, value) in reference.iter_mut().enumerate() {
                    ...
                    assert_eq!(
                        program.address_register(&reference),
                        reference[program.address_reg as usize]
                    );
                    program.execute_reference(&mut reference);
                    program.execute_compact(&mut compact);
                    assert_eq!(compact, reference);
                    #[cfg(feature = "unchecked-superscalar")]
                    {
                        let mut unchecked = reference;
                        // `reference` now contains one execution, so reconstruct the
    ...
    fn every_paired_handler_matches_sequential_dispatch() {
        ...
        for (first_index, &first_opcode) in opcodes.iter().enumerate() {
            for (second_index, &second_opcode) in opcodes.iter().enumerate() {
                ...
                first.pair_handler_offset =
                    ((first_index * 10 + second_index) * std::mem::size_of::<PairHandler>()) as u16;
                let input = [
                    0,
                    1,
                    u64::MAX,
